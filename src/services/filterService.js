...
class FilterService {
   ...
   */
  getMunicipalitiesForRegions(selectedRegions = []) {
   ...
   */
  toFilterValuesArray(apiFilters) {
    const filterValues = [];
   ...
   */
  getMetricFiltersForContext(metricIDs, context) {
    const metricFilters = [];
